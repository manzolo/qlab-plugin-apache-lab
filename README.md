...
python3 tools/walkthrough/build.py ../qlab-plugin-apache-lab        # English
python3 tools/walkthrough/build.py ../qlab-plugin-apache-lab -it    # Italian
python3 tools/walkthrough/build.py ../qlab-plugin-apache-lab --live # re-capture first
```
